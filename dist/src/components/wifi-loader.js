...
let WifiLoader = class WifiLoader extends LitElement {
    constructor() {
        super(...arguments);
        this.text = "Searching";
    }
...
], WifiLoader.prototype, "text", void 0);
WifiLoader = __decorate([
    customElement("wifi-loader")
], WifiLoader);
export { WifiLoader };
//# sourceMappingURL=wifi-loader.js.map